...
bc. mkdir blas
bc. cd blas
bc. mv ~/Downloads/DOWNLOADED_GOTOBLAS2.tar.gz .
bc. tar -xzvf DOWNLOADED_GOTOBLAS2.tar.gz
bc. cd GotoBLAS2
bc. make clean
bc. make
...
bc. make cleanb
bc. make TARGET=NEHALEM
bc. [davidg@ampre GotoBLAS2]$ ls -alh | grep libgoto2
...
bc. mkdir lapack
bc. cd lapack
bc. wget http://www.netlib.org/lapack/lapack-3.4.0.tgz
bc. tar -xzvf lapack-3.4.0.tgz
bc. cd lapack-3.4.0/
bc. cp make.inc.example make.inc
bc. vim make.inc
...
bc. mkdir lapack95
bc. cd lapack95
bc. wget http://www.netlib.org/lapack95/lapack95.tgz
bc. tar -xzvf lapack95.tgz
bc. cd LAPACK95
bc. cp make.inc_linux_rehdat make.inc
bc. vim ../make.inc
...
bc. cd SRC
bc. make single_double_complex_dcomplex
